(function () {
  ...
  fetch('/plugins/zfs.autosnapshot/php/dataset-inventory.php', {credentials: 'same-origin', signal: controller.signal})
    .then(response => response.text()).then(text => {
      ...
      if (label) label.textContent = 'Dataset discovery failed. Saved selections are preserved. ' + error.message;
