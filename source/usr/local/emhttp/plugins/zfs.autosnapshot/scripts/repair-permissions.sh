...
SNAPSHOT_MANAGER_ROOT="${SNAPSHOT_MANAGER_ROOT:-/tmp/zfs-autosnapshot-snapshot-manager}"
...
FAILED_SEND_LOGS_DIR="${FAILED_SEND_LOGS_DIR:-/var/log/zfs-autosnapshot-failed-sends}"
PERSISTED_QUEUE_DIR="${PERSISTED_QUEUE_DIR:-/tmp/zfs-autosnapshot-ops/runtime_queue}"
RECOVERY_ROOT="${RECOVERY_ROOT:-${BOOT_PLUGIN_DIR}/recovery_tools}"
RECOVERY_SCANS_DIR="${RECOVERY_SCANS_DIR:-${RECOVERY_ROOT}/scans}"
MIGRATOR_ROOT="${MIGRATOR_ROOT:-/tmp/zfs-autosnapshot-migrator}"
...
ensure_executable "/usr/local/sbin/zfs_autosnapshot_queue_handler"
