...
set -euo pipefail
config_dir="${ZFSAS_LEGACY_CONFIG_DIR:-/boot/config/plugins/zfs.autosnapshot}"
ops_root="${ZFSAS_RUNTIME_OPS_DIR:-/tmp/zfs-autosnapshot-ops}"
migrator_root="${ZFSAS_RUNTIME_MIGRATOR_DIR:-/tmp/zfs-autosnapshot-migrator}"
failed_logs="${ZFSAS_RUNTIME_FAILED_LOGS_DIR:-/var/log/zfs-autosnapshot-failed-sends}"
