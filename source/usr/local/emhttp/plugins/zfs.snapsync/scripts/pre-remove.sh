...
CRON_FILE="/etc/cron.d/zfs_snapsync"
...
CONFIG_FILE="/boot/config/plugins/zfs.snapsync/zfs_snapsync.conf"
...
SEND_CONFIG_FILE="/boot/config/plugins/zfs.snapsync/zfs_send.conf"
