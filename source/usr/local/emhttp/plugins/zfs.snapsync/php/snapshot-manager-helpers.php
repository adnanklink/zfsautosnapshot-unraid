...
{
    return '/tmp/zfs-snapsync-snapshot-manager';
}
...
{
    return '/var/run/zfs-snapsync-manager';
}
...
{
    $error = null;
    $script = '/usr/local/sbin/zfs_snapsync_snapshot_manager_worker';
    $log = '/var/log/zfs_snapsync_snapshot_manager.log';
